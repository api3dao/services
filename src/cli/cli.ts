...
const getAvailableTemplates = () => readdirSync(TEMPLATE_DIR);
const getTemplatePath = (template: string) => join(TEMPLATE_DIR, template);

// TODO: test
const createProjectUsingTemplate = (path: string, template: string) => {
